  ...
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Asafa Mahfuz Abiodun" },
      {
        name: "keywords",
        content:
          "Asafa Mahfuz Abiodun, Spencer, Enterprise Support, Network Support Services, Galaxy Backbone, Cybersecurity, Blue Team, LAUTECH, NAIS President, LSUG Secretary General",
      },
